...
The data is stored in the :py:class:`~atlas_core.models.Cat` model and the reasons
...
.. autoflask:: atlas_core:create_app({'DEBUG':False})
    :undoc-static:

Python API Reference
--------------------

.. autoclass:: atlas_core.models.Cat
    :members:
